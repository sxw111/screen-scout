...
def upgrade() -> None:
    ...
    op.create_table('user_watchlist_series',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('series_id', sa.Integer(), nullable=False),
    sa.Column('added_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['series_id'], ['series.id'], name=op.f('fk_user_watchlist_series_series_id_series')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_watchlist_series_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'series_id', name=op.f('pk_user_watchlist_series'))
    )
    ...
    op.create_table('user_watchlist_movies',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('movie_id', sa.Integer(), nullable=False),
    sa.Column('added_at', sa.TIMESTAMP(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], name=op.f('fk_user_watchlist_movies_movie_id_movies')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_watchlist_movies_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'movie_id', name=op.f('pk_user_watchlist_movies'))
    )
